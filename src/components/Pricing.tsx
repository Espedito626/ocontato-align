      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Planos para <span className="gradient-primary bg-clip-text text-transparent">prestadores</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {plans.map((plan) => (
            <div 
              key={plan.name}
              className={`relative bg-card rounded-2xl p-8 shadow-card border transition-smooth hover:scale-105 ${
                plan.popular 
