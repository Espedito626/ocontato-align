...
const Hero = () => {
  ...
  return <section className="relative min-h-[90vh] flex items-center justify-center px-4 gradient-dark">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="flex flex-col md:flex-row gap-3 p-2 bg-card rounded-xl shadow-card border border-border/50">
              <div className="flex-1 relative">
                ...
                <Input placeholder="Ex: Preciso de um encanador urgente..." className="pl-10 h-14 border-0 bg-secondary/50 text-lg focus-visible:ring-primary" />
              </div>
              <Button size="lg" className="h-14 px-8 gradient-primary hover:shadow-glow transition-smooth" onClick={() => navigate('/search')}>
                Buscar Agora
              </Button>
            </div>
          </div>
